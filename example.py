...
def main():
    ...
    memory_thread = builder.add_thread("Memory")
    ...
    timestamp += 500
    flow_process = builder.add_flow(io_thread, "Process Key Read", timestamp, flow_id)
    ...
    print(f"Open https://ui.perfetto.dev and load the file to view the trace")
